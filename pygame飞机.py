...
class PlayerSprite(pygame.sprite.Sprite):
    ...
    def __init__(self): 
        super().__init__()
        self.image = pygame.image.load('C:/MyFile/plane.png').convert() # load函数，返回一个 Surface 对象
...
class EnemySprite(pygame.sprite.Sprite):
    ...
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load('C:/MyFile/boom.png').convert()
        self.image.set_colorkey((255, 255, 255), RLEACCEL)
...
class CloudSprite(pygame.sprite.Sprite):
    ...
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load('C:/MyFile/cloud.png').convert()
